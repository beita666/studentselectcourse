...
<div class="login-box">
    <div class="login-logo">
        <a href="all-admin-index.html"><b>学生</b>网上选课系统</a>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
        <p class="login-box-msg">登录系统</p>

        <form action="${pageContext.request.contextPath}/login/loginTo" method="post">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2"  name="typeId" style="width: 100%;">
                    ...
                    <option value="3">系管理员</option>
                    <option value="4">院管理员</option>
