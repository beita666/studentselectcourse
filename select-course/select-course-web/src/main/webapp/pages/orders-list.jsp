								...
								<tbody>
									...
									<c:forEach items="${studentList}" var="students">
										...
										<tr>
											...
											<td class="text-center">${students.studentNum }</td>
											<td class="text-center">${students.name }</td>
											<td class="text-center">${students.sex }</td>
											<td class="text-center">${students.sex }</td>
											<td class="text-center">${students.department }</td>
											<td class="text-center">${students.profession }</td>
											<td class="text-center">${students.enterTime }</td>
											<td class="text-center">${students.type }</td>
											<td class="text-center">${students.phoneNumber }</td>
